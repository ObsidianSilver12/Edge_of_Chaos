...
class BrainSeed:
    ...
    def add_creator_energy(self, energy_amount: float | None = None) -> Dict[str, Any]:
        """
    ...
    def place_brain_seed(self, position: Optional[Tuple[int, int, int]] = None) -> Dict[str, Any]:
        """
