...
try:
    ...
    logger.critical(f"CRITICAL ERROR: Could not import constants from constants: {e}. Identity Crystallization cannot function correctly.")
    raise ImportError(f"Essential constants missing: {e}") from e

# --- Dependency Imports ---
try:
    from stage_1.soul_formation.soul_spark import SoulSpark
    # from stage_1.sephiroth.sephiroth_aspect_dictionary import aspect_dictionary the sephiroth fields use aspects directly
    # Import Edge of Chaos functions/classes if available
    try:
        from stage_1.soul_formation.edge_of_chaos import * # Import all edge_of_chaos functionality for potential future use
