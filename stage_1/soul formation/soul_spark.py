...
# Visualize the spark
spark.visualize_spark()

# Visualize energy signature
spark.visualize_energy_signature()

# Save spark data
output_dir = "output"
os.makedirs(output_dir, exist_ok=True)
spark.save_spark_data(os.path.join(output_dir, f"spark_{spark.spark_id[:8]}.json"))

# Save visualizations
spark.visualize_spark(show=False, save_path=os.path.join(output_dir, f"spark_{spark.spark_id[:8]}.png"))
spark.visualize_energy_signature(show=False, save_path=os.path.join(output_dir, f"spark_energy_{spark.spark_id[:8]}.png"))