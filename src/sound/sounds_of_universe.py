...
try:
    from src.constants import (
        SAMPLE_RATE, MAX_AMPLITUDE, OUTPUT_DIR_BASE, PHI, GOLDEN_RATIO, PI,
        SPEED_OF_LIGHT, PLANCK_CONSTANT, GRAVITATIONAL_CONSTANT, # Physical constants might not be directly used for sound gen
        ELECTRON_MASS, PROTON_MASS, # Mass ratio might be used
