    ...
    def calculate_boundary_strength(self, entity=None):
        ...
        if entity and isinstance(entity, dict):
            ...
            if "strength" in entity:
                ...
                base_boundaries["physical"] = base_boundaries["physical"] * strength_factor
            
            # Add discipline modification
            if "discipline" in entity:
                discipline_factor = 0.6 + 0.4 * entity["discipline"]
                base_boundaries["mental"] = base_boundaries["mental"] * discipline_factor
                base_boundaries["emotional"] = base_boundaries["emotional"] * (0.8 + 0.2 * discipline_factor)
